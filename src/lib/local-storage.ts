...
export const STORAGE_KEYS = { profile: "listoficios:professional-draft:v2", legacyProfile: "listoficios:professional-draft:v1", legacyAgenda: "listoficios:agenda:v1", favorites: "listoficios:favorites:v1", contacts: "listoficios:contact-events:v1", support: "listoficios:support-tickets:v1" } as const;
