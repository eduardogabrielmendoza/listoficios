...
import { TrustJourney } from "@/components/trust-journey";
...
export default function Home() {
  return (
    <main className="overflow-hidden" data-motion-home>
      <DiscoveryExperience initialProfessionals={professionals} />
      ...
      <section id="como-funciona" data-motion-how className="how-journey scroll-mt-20">
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="how-map">
            ...
            <svg className="how-map-route-mobile" viewBox="0 0 320 760" fill="none" aria-hidden="true"><path data-motion-how-path d="M160 44C82 122 82 202 160 260C238 318 238 408 160 466C82 524 82 626 160 712" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /><path d="M160 44C82 122 82 202 160 260C238 318 238 408 160 466C82 524 82 626 160 712" stroke="currentColor" strokeWidth="12" strokeLinecap="round" opacity=".05" /></svg>
